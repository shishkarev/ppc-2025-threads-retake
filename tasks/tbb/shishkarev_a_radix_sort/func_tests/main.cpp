...
TEST(shishkarev_a_radix_sort_tbb, test_sort_small) {
  ...
  shishkarev_a_radix_sort_tbb::TestTaskTBB test_task_tbb(task_data_tbb);
...
TEST(shishkarev_a_radix_sort_tbb, test_sort_medium) {
...
TEST(shishkarev_a_radix_sort_tbb, test_sort_negative_numbers) {
...
TEST(shishkarev_a_radix_sort_tbb, test_sort_from_file) {
  // Создаем тестовый файл
  std::ofstream test_file("test_radix_tbb.txt");
  test_file << "20\n";
  test_file << "542\n-123\n789\n0\n42\n-56\n999\n1234\n-789\n1000\n";
  test_file << "-42\n555\n-999\n777\n-1\n888\n-100\n333\n666\n";
  test_file.close();

  std::ifstream input_file("test_radix_tbb.txt");
  size_t count = 0;
  input_file >> count;
